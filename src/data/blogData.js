export const blogData = [
    {
        id: 1,
        title: 'Cloning Solidity smart contracts using the factory pattern',
        description: 'The factory design pattern is a well-known programming pattern. The concept is simple: instead of directly creating instances of objects,',
        date: 'June 16, 2022',
        image: 'https://blog.logrocket.com/wp-content/uploads/2022/01/factory-pattern-right-way-create-multiple-instances-solidity-smart-contract.png',
        url: 'https://blockchainscientist.blogspot.com/2022/06/cloning-solidity-smart-contracts-using.html'
    },
    {
        id: 2,
